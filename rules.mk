...
# need to add it here.
PROJECT_INCLUDE_DIRS := inc
PROJECT_INCLUDE_DIRS += libmaple/libraries/FreeRTOS
...
CXXFLAGS_$(d) := -DCLI=1 -DDEBUG=1 $(FLAGS_ABS_INCLUDE)
